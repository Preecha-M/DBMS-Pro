...
export default function InventoryPage() {
  ...
  const handleSaveCategory = async (e) => {
    e.preventDefault();
    setError(""); setSuccess("");
    if (!catForm.category_name) {
      return setError(t('inventory.errDefault'));
    }
  ...
  return (
    <div className="page-pad">
      <div className="inventory-desktop-wrapper">
        ...
        <div className={`inv-tab ${tab === "categories" ? "active" : ""}`} onClick={() => { setTab("categories"); setError(""); setSuccess(""); }}>
